...
define(['./defaultValue-69ee94f4', './Matrix2-2baea4e7', './ArcType-e1641d8d', './GeometryOffsetAttribute-4d39b441', './BoundingRectangle-a82e86bb', './Transforms-c444c5a1', './RuntimeError-ac440aa5', './ComponentDatatype-07fbb0d4', './EllipsoidGeodesic-9cac78c9', './EllipsoidTangentPlane-3acd64e5', './GeometryAttribute-715c53e3', './GeometryInstance-43427201', './GeometryPipeline-e4b35aae', './IndexDatatype-0b020dfb', './PolygonGeometryLibrary-7ded3871', './PolygonPipeline-70e56000', './VertexFormat-e68722dd', './_commonjsHelpers-3aae1032-15991586', './combine-0259f56f', './WebGLConstants-f63312fc', './AxisAlignedBoundingBox-d40b9bf5', './IntersectionTests-cb3bd4b3', './Plane-466bf0b1', './AttributeCompression-e7c014d6', './EncodedCartesian3-36c97b8b', './arrayRemoveDuplicates-7d5d09a3', './EllipsoidRhumbLine-96b0ed89', './GeometryAttributes-1b4134a9'], (function (defaultValue, Matrix2, ArcType, GeometryOffsetAttribute, BoundingRectangle, Transforms, RuntimeError, ComponentDatatype, EllipsoidGeodesic, EllipsoidTangentPlane, GeometryAttribute, GeometryInstance, GeometryPipeline, IndexDatatype, PolygonGeometryLibrary, PolygonPipeline, VertexFormat, _commonjsHelpers3aae1032, combine, WebGLConstants, AxisAlignedBoundingBox, IntersectionTests, Plane, AttributeCompression, EncodedCartesian3, arrayRemoveDuplicates, EllipsoidRhumbLine, GeometryAttributes) { 'use strict';
  ...
  PolygonGeometry.createGeometry = function (polygonGeometry) {
    ...
    if (extrude) {
      ...
      for (i = 0; i < polygons.length; i++) {
        ...
        // THING.EARTH2.0
        groups.push({ start: startIndex, count: topAndBottom.geometry.indices.length, materialIndex: materialIndex });
        ...
        for (let k = 0; k < walls.length; k++) {
          ...
          // THING.EARTH2.0
          groups.push({ start: startIndex, count: wall.geometry.indices.length, materialIndex: materialIndex });
          materialIndex++;
      ...
      for (i = 0; i < polygons.length; i++) {
        ...
        // THING.EARTH2.0
        groups.push({ start: startIndex, count: geometryInstance.geometry.indices.length, materialIndex: materialIndex });
        materialIndex++;
