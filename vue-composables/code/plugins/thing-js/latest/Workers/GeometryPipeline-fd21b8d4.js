...
define(['exports', './AttributeCompression-2dd10f06', './Matrix2-4c595574', './RuntimeError-ac440aa5', './defaultValue-69ee94f4', './ComponentDatatype-7ed489c0', './Transforms-6d17947d', './EncodedCartesian3-13f8b457', './GeometryAttribute-622eac56', './IndexDatatype-b58b63e4', './IntersectionTests-8051e793', './Plane-3d92c6f0'], (function (exports, AttributeCompression, Matrix2, RuntimeError, defaultValue, ComponentDatatype, Transforms, EncodedCartesian3, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) { 'use strict';
  ...
  GeometryPipeline.projectTo2D = function (
    ...
    attributeName2D,
    projection,
    needsTranslateAmericaToEast=false
  ) {
    //>>includeStart('debug', pragmas.debug);
    if (!defaultValue.defined(geometry)) {
      throw new RuntimeError.DeveloperError("geometry is required.");
    ...
    for (let i = 0; i < values3D.length; i += 3) {
      ...
      if(needsTranslateAmericaToEast&&lonLat.longitude<-30*Math.PI/180){
...
//# sourceMappingURL=GeometryPipeline-fd21b8d4.js.map
